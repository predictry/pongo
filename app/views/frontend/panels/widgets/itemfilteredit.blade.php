<div class="item_filter" id="item_filter{{ $index_item_widget_filter }}">
	<div class="col-sm-4 form-group">
		...
		<?php echo Form::select("filter_id[]", $filter_list, $obj['filter_id'], array('class' => 'form-control chosen-select-item', 'id' => "itemfilter{$index_item_widget_filter}", 'data-placeholder' => "Choose Item...")); ?>
	</div>
