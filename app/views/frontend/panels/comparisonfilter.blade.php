			...
			<div class="form-group text-left">
				...
				<div class="btn-group" id="range-type">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="{{ URL::to('home2/'. $comparison_type_by[0] . '/' . $type . '/' . $type_by) }}">{{ $comparison_list[0] }}</a></li>
						<li><a href="{{ URL::to('home2/'. $comparison_type_by[1] . '/' . $type . '/' . $type_by) }}">{{ $comparison_list[1] }}</a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="form-group text-left">
			<div class="btn-group" id="range-type">
				...
				<ul class="dropdown-menu pull-right" role="menu">
					<li><a href="{{ URL::to('home2/'. $selected_comparison . '/' . $type. '/' . 'day') }}">Day</a></li>
					<li><a href="{{ URL::to('home2/'. $selected_comparison . '/' . $type . '/' . 'week') }}">Week</a></li>
					<li><a href="{{ URL::to('home2/'. $selected_comparison  . '/' . $type . '/' . 'month') }}">Month</a></li>
				</ul>
			</div>
		</div>
	</div>
