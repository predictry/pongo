...
<div class="item_rule" id="item_rule{{ $index_item_rule }}">
	<div class="col-sm-3 form-group">
		...
		<div class="clearfix"></div>
		<?php echo Form::select("item_id[]", $items, null, array('class' => 'form-control chosen-select-item', 'id' => "item{$index_item_rule}", 'data-placeholder' => "Choose Item...")); ?>
	</div>
	<div class="col-sm-3 form-group">
		<label for='item1' class="control-label">Rule Type</label>
		<div class="clearfix"></div>
		<?php echo Form::select("type[]", $enum_types, "excluded", array('class' => 'form-control', 'id' => "type{$index_item_rule}")); ?>
	</div>
	...
	<div class="col-sm-3 form-group">
		...
		<div class="clearfix"></div>
		@if ($index_item_rule > 1)
		<a href="javascript:void(0);" class="btn btnRemoveItemPlacementRuleset btn-danger" onClick="removeItemRule({{ $index_item_rule }}, 'item_rule');"><i class="fa fa-minus"></i></a>
		@endif
	</div>
</div>