<div class="wizardModalSiteFormContainer">
    {{ Form::open(array('url' => 'v2/sites/ajaxSubmitSite', 'class' => 'form-horizontal wizardModalSiteForm')) }}
    ...
    <div class="form-group {{$var = $errors->first('site_category_id')}} {{ ($var !== '') ? 'has-error' : ''}}">
        <label for="site_category_list" class="col-sm-3 control-label">Site Category</label>
        <div class="col-sm-5">
