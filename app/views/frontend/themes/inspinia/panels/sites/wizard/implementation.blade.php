            ...
            <div class="ibox float-e-margins">
                <div class="main form-group">
                    ...
                    <ul class="nav nav-pills nav-justified thumbnail setup-panel">
                        <li class="active">
                            <a href="#step-embed-js">
                                <h4 class="list-group-item-heading">Step 1</h4>
                                <p class="list-group-item-text">Embed JS</p>
                            </a>
                        </li>
                        <li class="disabled">
                            <a href="#step-data-collection">
...
<script type="text/javascript">
                            ...
                            <div class="row">
                                ...
                                <div class=" col-sm-4 pt20">
                                    <button class="btn btn-primary pull-right" id="btn-embed-continue">Apply & Continue</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                                                    ...
                                                                    <ul class="nav nav-stacked nav-pills actions">
                                                                        ...
                                                                        foreach ($actions as $action) {
                                                                            ...
                                                                            <li id="item-action-{{ $action->name }}">
                                                                                <div class="col-xs-10">
                                                                                    <a href="javascript:void(0);" onclick="getActionProperties('{{ $tenant_id }}', '{{ $action->name }}');">
