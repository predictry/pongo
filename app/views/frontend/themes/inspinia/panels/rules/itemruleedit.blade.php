<div class="item_rule clearfix" id="item_rule{{ $index_item_rule }}">
    <div class="col-sm-4 form-group">
        ...
        <?php echo Form::select("item_id[]", $items, $obj['item_id'], array('class' => 'form-control chosen-select-rules', 'id' => "item{$index_item_rule}", 'data-placeholder' => "Choose Item...")); ?>
    </div>
    <div class="col-sm-3 form-group">
        <label for='item1' class="control-label">Rule Type</label>
        <div class="clearfix"></div>
        <?php echo Form::select("type[]", $enum_types, $obj['type'], array('class' => 'form-control chosen-select', 'id' => "type{$index_item_rule}")); ?>
    </div>
