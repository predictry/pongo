...
return array(
    ...
    "error.login.failed"               => "Your email/password combination was incorrect.",
    "error.email.doesnt.exists"        => "Email you have entered doesn't exists.",
    "error.account.have.not.confirmed" => "Account have not confirmed yet. Please check the email that we have send to you earlier.",
