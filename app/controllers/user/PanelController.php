...
class PanelController extends BaseController
{
    ...
    public function index2($selected_comparison = "pageview", $type = "7_d_ago", $date_unit = "day", $dt_start = null, $dt_end = null)
    {
        ...
        $sales_stats                        = $this->_populateSalesStatsByRangesFromCache($dt_ranges, $date_unit);
        $pageviews_stats                    = $this->_populatePageViewStatsByRangesFromCache($dt_ranges, $date_unit);
    ...
    function _getFunelStatsInfo($action_ids, $dt_start, $dt_end)
    {
        ...
        $available_non_default_site_action_ids   = Action::where("site_id", $this->active_site_id)->whereNotIn("id", $action_ids)->get()->lists("id");
    ...
    {
        $site_actions = Action::where("site_id", $this->active_site_id)->get(array("id", "name"))->toArray();
