    ...
    public function postSiteOverviewSummary($dt_range_group = "today", $dt_start = null, $dt_end = null)
    {
        if (Request::ajax()) {
            ...
            if (is_null($cache_pageviews_stat)) {
                ...
                $pageviews_stat = (isset($arr_response['error']) && $arr_response['error']) ? ['overall' => 0.0, 'regular' => 0.0, 'recommended' => 0.0] : array_get($arr_response, 'data.pageviews');
            ...
            if (is_null($cache_summary_item_purchased)) {
                ...
                $arr_response           = $response->json();
                $summary_item_purchased = (isset($arr_response['error']) && $arr_response['error']) ? ['overall' => 0.0, 'regular' => 0.0, 'recommended' => 0.0] : array_get($arr_response, 'data.sum');
            ...
            if (is_null($cache_summary_sales)) {
                ...
                $arr_response  = $response->json();
                $summary_sales = (isset($arr_response['error']) && $arr_response['error']) ? ['overall' => 0.0, 'regular' => 0.0, 'recommended' => 0.0] : array_get($arr_response, 'data.sum');
            ...
            if (is_null($cache_n_orders)) {
                ...
                $arr_response = $response->json();
                $n_orders     = (isset($arr_response['error']) && $arr_response['error']) ? 0.0 : array_get($arr_response, 'data.count');
            ...
            if (is_null($cache_n_sessions)) {
                ...
                $arr_response = $response->json();
                $n_sessions   = (isset($arr_response['error']) && $arr_response['error']) ? 0.0 : array_get($arr_response, 'data.count');
            ...
            if (is_null($cache_n_skus)) {
                ...
                $arr_response = $response->json();
                $n_skus       = (isset($arr_response['error']) && $arr_response['error']) ? 0.0 : array_get($arr_response, 'data.count');
            ...
            if (is_null($cache_n_top_bought_items)) {
                ...
                $arr_response     = $response->json();
                $top_bought_items = (isset($arr_response['error']) && $arr_response['error']) ? 0.0 : array_get($arr_response, 'data.items');
            ...
            $output = [
                'overviews' => [
                    ...
                    'total_item_per_cart'  => number_format(($n_orders) > 0 ? ($summary_item_purchased['regular'] / $n_orders) : 0.0, 2),
                    'total_sales_per_cart' => number_format(($n_orders) > 0 ? ($summary_sales['regular'] / $n_orders) : 0.0),
