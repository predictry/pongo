...
var f=""
if(f+="<a href='"+m+"' target='_self' title='"+e.name+"'>",f+="<span class='name'>"+e.name+"</span>",f+="</a>",d.innerHTML=f,e.net_price){var u=""
u+="<span class='priceCurrency'>"+n+"</span>",u+="<span class='price net_price'>"+e.net_price+"</span>",l.innerHTML=u}else{var u=""
u+="<span class='priceCurrency'>"+n+"</span>",u+="<span class='price'>"+e.price+"</span>",l.innerHTML=u}return s.appendChild(c),s.appendChild(d),s.appendChild(l),o.appendChild(s),draw_reco_seq+=1,o}return!1}function createHeaderDiv(e){var t=document.createElement("div")
...
localStorage.setItem("recentlyViewedItems",value)}}function removeItemDetails(id){var recentlyItems=eval(localStorage.getItem("recentlyViewedItems")),temp_items=[]
if(null!==recentlyItems){[].forEach.call(recentlyItems,function(e){e.item_id!==id&&temp_items.push(e)})
var value=JSON.stringify(temp_items)
localStorage.setItem("recentlyViewedItems",value)}}function checkItemId(id){var recentlyItems=eval(localStorage.getItem("recentlyViewedItems")),out=0
return null!==recentlyItems&&[].forEach.call(recentlyItems,function(e){e.item_id==id&&(out=1)}),out}function showRecentlyViewedItems(id){if(eval(localStorage.getItem("recentlyViewedItems"))){var recentlyViewedItems=eval(localStorage.getItem("recentlyViewedItems"))
...
else{var recentlyItems=eval(localStorage.getItem("recentlyViewedItems"))
if(null!==recentlyItems)if(recentlyItems.length==config_recent_limit){recentlyItems.pop(),recentlyItems.unshift(data.items[0])
var value=JSON.stringify(recentlyItems)
localStorage.setItem("recentlyViewedItems",value)}else addItemIntoRecentlyViewedSession(data.items[0])
else addItemIntoRecentlyViewedSession(data.items[0])}sendImage(data)}function recentlyItemsCallback(callback,max){var recentlyViewedItems=eval(localStorage.getItem("recentlyViewedItems"))
if(1==recentlyViewedItems.length&&(recentlyViewedItems.length=0),max){for(var limitedItems=[],i=0;max>i;i++)recentlyViewedItems[i]&&limitedItems.push(recentlyViewedItems[i])
callback(limitedItems)}else callback(recentlyViewedItems)}function typedUniversalCallback(e,t,i,n){function r(e){if(isDefined(e)&&isObject(e)){var n=[];[].forEach.call(e,function(r){var o=config_s3_data_items_path.replace("{tenant}",tenant_id),s=config_s3_resource_url+o+r+config_default_s3_resource_ext
getJSON(s,function(o){if(isDefined(o)){var s=isDefined(e.length)&&""!==e.length?e.length:0,c={id:isDefined(a)?a:0,len:s,algo:isDefined(t)&&""!==t?t:""},d=JSON.parse(o)
for(var l in c)c.hasOwnProperty(l)&&0!==c[l]&&""!==c[l]&&(d.item_url=addParameter(d.item_url,config_prefix_param+l,c[l]))
d.item_url=addParameter(d.item_url,config_prefix_param+"seq",draw_reco_seq),n.push(d),n.length==e.length&&i(n)}else{var m={error:"There is no item details on server for item_id: "+r+" yet."}
n.push(m),n.length==e.length&&i(n)}})})}else{var r=void 0
i(r)}}var a=e
getItems(e,t,r,n)}function trackBuy(data){if(isDefined(data)&&isObject(data)){data=appendPredictryData(data)
...
return t?!0:!1}function getItems(e,t,i,n){var r=[]
if("similar"==t){var a=config_s3_resource_url+config_s3_data_similar_path.replace("{tenant}",tenant_id)+e+config_default_s3_resource_ext,o=new XMLHttpRequest
return o.open("GET",a,!0),o.onreadystatechange=function(){if(4==o.readyState)if(200==o.status&&o.responseText.length>0)if(r=JSON.parse(o.responseText).items,isDefined(n)){for(var t=[],a=0;n>a;a++)t.push(r[a])
i(t)}else i(r)
else{if(403==o.status){var s=config_fisher_endpoint+"/"+tenant_id+"/related/"+e
return console.log(s),o.open("GET",s,!0),o.onreadystatechange=function(){if(4==o.readyState)if(200==o.status&&o.responseText.length>0)if(r=JSON.parse(o.responseText).items,isDefined(n)){for(var e=[],t=0;n>t;t++)e.push(r[t])
i(e),console.log(e)}else console.log(r),i(r)
else i(void 0)},o.send(),r}i(void 0)}},o.send(),r}var s=config_s3_data_recommendation_path.replace("{tenant}",tenant_id),c=config_s3_resource_url+s+t+"/"+e+".json",o=new XMLHttpRequest
return o.open("GET",c,!0),o.onreadystatechange=function(){if(4==o.readyState)if(200==o.status&&o.responseText.length>0)if(r=JSON.parse(o.responseText).items,isDefined(n)){for(var e=[],t=0;n>t;t++)e.push(r[t])
i(e)}else i(r)
else i(void 0)},o.send(),r}function loadItems(e,t,i){drawAsyncThumbListRecommendation(e,t,i)}function showTypedItems(e){var t,i,n=document.querySelectorAll(".predictry-"+e)[0],r=n.attributes["data-predictry-item-id"].value
isDefined(n.attributes["data-predictry-title"])&&("false"!==n.attributes["data-predictry-title"].value?t=n.attributes["data-predictry-title"].value:i=!0)
var a={limit:n.attributes["data-predictry-limit"].value,typed:e,hide_title:i,title:isDefined(t)&&""!==t?t:config_typed_titles[e]},o=function(t){loadItems(n,t,a,e)}
getItems(r,e,o)}function checkWidget(){[].forEach.call(config_widget_type,function(e){checkPredictryType(e)&&showTypedItems(e)})}var tenant_id=tenant_id,api_key=api_key,baseURL,response={},data={},widget_id=0,widget_instance_id=0,temp_cart_id=-1,tracking_params=null,predictry_nodes={},widgets=[],is_lookup_widget=!1,config_cookie_name_prefix="_predictry_",config_cookie_disabled=!1,config_cookie_path="/",config_default_request_method="POST",config_request_method=config_default_request_method,config_default_request_content_type="application/x-www-form-urlencoded; charset=UTF-8",config_request_content_type=config_default_request_content_type,config_api_url="https://api.predictry.com/",config_cf_trackings_url="https://d1j642hg7oh3vx.cloudfront.net/",config_s3_resource_url="https://s3-ap-southeast-1.amazonaws.com/predictry/",config_api_resources=["actions","users","items","carts","cartlogs","recommendation","bookmark"],config_default_actions=["view","add_to_cart","buy","started_checkout","started_payment","check_delete_item","delete_item","custom","bookmark"],config_session_cookie_timeout=63072e6,config_tracking_session_cookie_timeout=12e5,config_do_not_track=!1,config_s3_data_similar_path="data/tenants/{tenant}/similiar/",config_s3_data_recommendation_path="data/tenants/{tenant}/recommendations/",config_s3_data_items_path="data/tenants/{tenant}/items/",config_s3_data_category_items_path="data/tenants/{tenant}/categories/",config_default_s3_resource_ext=".json",config_cls_prefix="pry-",config_prefix_param="p_",config_fisher_endpoint="http://fisher.predictry.com:8090/fisher/items",config_widget_type=["similar","oivt","oipt","duo","oip","oiv"],config_recent_limit=20,config_typed_titles={similar:"Similar Items",oivt:"Viewed also viewed",oipt:"Bought also bought",duo:"Combined",oiv:"Other Items Viewed",oip:"Other Items Purchase"},recent_response,recent_xhr=null,draw_reco_seq=1
return{bookmark:function(e){isDefined(e)&&isObject(e)&&isDefined(e.items)&&(config_request_content_type="application/json; charset=utf-8",sendRequest(config_api_url+config_api_resources[6],e,!0,null,!0))},setTenantId:function(e){tenant_id=e},setApiKey:function(e){api_key=e},setWidgetId:function(e){widget_id=e},setSessionID:function(e){var t=getCookie(getCookieName("session"))
