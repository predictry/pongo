...
return a.open("GET",r,!0),a.onreadystatechange=function(){4==a.readyState&&(200==a.status&&a.responseText.length>0?(n=JSON.parse(a.responseText).items,i(n)):i(void 0))},a.send(),n}function loadItems(e,t,i){drawAsyncThumbListRecommendation(e,t,i)}function showTypedItems(e){var t=document.querySelectorAll(".predictry-"+e)[0],i=t.attributes["data-predictry-item-id"].value,n={limit:t.attributes["data-predictry-limit"].value,typed:e,title:config_typed_titles[e]},r=function(i){loadItems(t,i,n,e)}
