...
return o.open("GET",s,!0),o.onreadystatechange=function(){if(4==o.readyState)if(200==o.status&&o.responseText.length>0)if(r=JSON.parse(o.responseText).items,isDefined(n)){for(var e=[],t=0;n>t;t++)e.push(r[t])
i(e)}else i(r)
