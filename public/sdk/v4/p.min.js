...
d.className="name",d.innerHTML=e.name,ul_obj.appendChild(t),t.appendChild(n),n.appendChild(r),r.appendChild(a),a.appendChild(o),n.appendChild(s),s.appendChild(c),c.appendChild(d)}i++})}}}function trackView(e){isDefined(e.action)&&isDefined(e.action.rec)&&setItemIntoViewSession(e.items[0].item_id),showRecentlyViewedItems(e.items[0].item_id),checkItemId(e.items[0].item_id)?(removeItemDetails(e.items[0].item_id),addItemIntoRecentlyViewedSession(e.items[0])):(addItemIntoRecentlyViewedSession(e.items[0]),addRecentlyViewedItemId(e.items[0].item_id)),sendImage(e)}function recentlyItemsCallback(callback){var recentlyViewedItems=eval("("+getCookie(getCookieName("recentlyViewedItems"))+")")
