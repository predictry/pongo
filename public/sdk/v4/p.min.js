...
return t?!0:!1}function getItems(e,t,i){var n=config_s3_data_recommendation_path.replace("{tenant}",tenant_id),r=config_s3_resource_url+n+t+"/"+e+".json",a=new XMLHttpRequest,o=[]
return a.open("GET",r,!0),a.onreadystatechange=function(){4==a.readyState&&200==a.status&&(o=JSON.parse(a.responseText).items,console.log(o),i(o))},a.send(),o}function loadItems(e,t,i){drawAsyncThumbListRecommendation(e,t,i)}function showTypedItems(e){var t=document.querySelectorAll(".predictry-"+e)[0],i=t.attributes["data-predictry-item-id"].value,n={limit:t.attributes["data-predictry-limit"].value,typed:e,title:config_typed_titles[e]},r=function(i){console.log("loaded"),loadItems(t,i,n,e)}
getItems(i,e,r)}function checkWidget(){[].forEach.call(config_widget_type,function(e){checkPredictryType(e)&&showTypedItems(e)})}var tenant_id=tenant_id,api_key=api_key,response={},data={},widget_id=0,widget_instance_id=0,temp_cart_id=-1,tracking_params=null,predictry_nodes={},predictryRecent={},widgets=[],is_lookup_widget=!1,config_cookie_name_prefix="_predictry_",config_cookie_disabled=!1,config_cookie_path="/",config_default_request_method="POST",config_request_method=config_default_request_method,config_default_request_content_type="application/x-www-form-urlencoded; charset=UTF-8",config_request_content_type=config_default_request_content_type,config_api_url="https://api.predictry.com/",config_cf_trackings_url="https://d1j642hg7oh3vx.cloudfront.net/",config_s3_resource_url="https://s3-ap-southeast-1.amazonaws.com/predictry/",config_api_resources=["actions","users","items","carts","cartlogs","recommendation"],config_default_actions=["view","add_to_cart","buy","started_checkout","started_payment","check_delete_item","delete_item","custom"],config_session_cookie_timeout=63072e6,config_tracking_session_cookie_timeout=12e5,config_recently_session_cookie_timeout=2592e6,config_do_not_track=!1,config_s3_data_recommendation_path="data/tenants/{tenant}/recommendations/",config_s3_data_items_path="data/tenants/{tenant}/items/",config_s3_data_category_items_path="data/tenants/{tenant}/categories/",config_default_s3_resource_ext=".json",config_cls_prefix="pry-",config_prefix_param="p_",config_fisher_endpoint="http://119.81.208.244:8090/fisher/items",config_widget_type=["similar","oivt","oipt","duo"],config_typed_titles={similar:"Similar Items",oivt:"Viewed also viewed",oipt:"Bought also bought",duo:"Both"},recent_response,recent_xhr=null,draw_reco_seq=1
