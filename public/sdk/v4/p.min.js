...
return setCookie(getCookieName("recentlyViewedItems"),i,config_tracking_session_cookie_timeout,config_cookie_path),e}function addItemIntoRecentlyViewedSession(data){var recentlyViewedItems=eval("("+getCookie(getCookieName("recentlyViewedItems"))+")")
...
setCookie(getCookieName("recentlyViewedItems"),value,config_tracking_session_cookie_timeout,config_cookie_path)}else setRecentlyViewedSessionCookie(data)}function setRecentlyViewedItemIdCookie(e){if(!isDefined(e)||!isObject(e))var e={v:[]}
var t=JSON.stringify(e)
return setCookie(getCookieName("recentlyViewedItemIds"),t,config_tracking_session_cookie_timeout,config_cookie_path),e}function addRecentlyViewedItemId(id){var recentlyIds=eval("("+getCookie(getCookieName("recentlyViewedItemIds"))+")")
...
setCookie(getCookieName("recentlyViewedItemIds"),value,config_tracking_session_cookie_timeout,config_cookie_path)}}else setRecentlyViewedItemIdCookie(id)}function checkItemId(id){var recentlyIds=eval("("+getCookie(getCookieName("recentlyViewedItemIds"))+")")
