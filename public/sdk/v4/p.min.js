...
i(e)}i(r)}else i(void 0)},o.send(),r}var s=config_s3_data_recommendation_path.replace("{tenant}",tenant_id),a=config_s3_resource_url+s+t+"/"+e+".json",o=new XMLHttpRequest
return o.open("GET",a,!0),o.onreadystatechange=function(){if(4==o.readyState)if(200==o.status&&o.responseText.length>0){if(r=JSON.parse(o.responseText).items,isDefined(n)){for(var e=[],t=0;n>t;t++)e.push(r[t]),console.log(r[t])
i(e)}i(r)}else i(void 0)},o.send(),r}function loadItems(e,t,i){drawAsyncThumbListRecommendation(e,t,i)}function showTypedItems(e){var t,i,n=document.querySelectorAll(".predictry-"+e)[0],r=n.attributes["data-predictry-item-id"].value
