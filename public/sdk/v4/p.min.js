...
callback(limitedItems)}else callback(recentlyViewedItems)}function typedUniversalCallback(e,t,i){function n(e){if(isDefined(e)&&isObject(e)){var n=[];[].forEach.call(e,function(a){var o=config_s3_data_items_path.replace("{tenant}",tenant_id),s=config_s3_resource_url+o+a+config_default_s3_resource_ext
getJSON(s,function(o){if(isDefined(o)){var s=isDefined(e.length)&&""!==e.length?e.length:0,c={id:isDefined(r)?r:0,len:s,algo:isDefined(t)&&""!==t?t:""},d=JSON.parse(o)
for(var l in c)c.hasOwnProperty(l)&&0!==c[l]&&""!==c[l]&&(d.item_url=addParameter(d.item_url,config_prefix_param+l,c[l]))
d.item_url=addParameter(d.item_url,config_prefix_param+"seq",draw_reco_seq),n.push(d),n.length==e.length&&i(n)}else{var m={error:"There is no item details on server for item_id: "+a+" yet."}
n.push(m),n.length==e.length&&i(n)}})})}else{var a=void 0
i(a)}}var r=e
getItems(e,t,n)}function trackBuy(data){if(isDefined(data)&&isObject(data)){data=appendPredictryData(data)
...
return t?!0:!1}function getItems(e,t,i){var n=[]
if("similar"==t){var r=config_fisher_endpoint+"/"+tenant_id+"/related/"+e,a=new XMLHttpRequest
return a.open("GET",r,!0),a.onreadystatechange=function(){4==a.readyState&&(200==a.status&&a.responseText.length>0?(n=JSON.parse(a.responseText).items,i(n)):i(void 0))},a.send(),n}var o=config_s3_data_recommendation_path.replace("{tenant}",tenant_id),r=config_s3_resource_url+o+t+"/"+e+".json",a=new XMLHttpRequest
return a.open("GET",r,!0),a.onreadystatechange=function(){4==a.readyState&&(200==a.status&&a.responseText.length>0?(n=JSON.parse(a.responseText).items,i(n)):i(void 0))},a.send(),n}function loadItems(e,t,i){drawAsyncThumbListRecommendation(e,t,i)}function showTypedItems(e){var t,i,n=document.querySelectorAll(".predictry-"+e)[0],r=n.attributes["data-predictry-item-id"].value
