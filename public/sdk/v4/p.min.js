...
if(baseURL&&(t.img_url=baseURL+t.img_url),isObject(t)){var n=createThumbRecoNode(t,draw_reco_seq,i,r.currency)
...
if(null==getItems)console.log("setting local storage"),setRecentlyViewedSessionCookie(data)
else{var items=getItems
items.push(data),console.log(items)
...
return inArray(id,itemIds)?!0:!1}return setRecentlyViewedItemIdCookie(id),!1}function showRecentlyViewedItems(id){var recentlyViewedItems=eval(localStorage.getItem("recentlyViewedItems"))
if(console.log(recentlyViewedItems),predictryRecent=document.querySelectorAll(".predictry-recent")[0]){var predictryRecent=document.querySelectorAll(".predictry-recent")[0],r_head=document.createElement("h2")
...
return a.open("GET",r,!0),a.onreadystatechange=function(){4==a.readyState&&200==a.status&&(o=JSON.parse(a.responseText).items,i(o))},a.send(),o}function loadItems(e,t,i){drawAsyncThumbListRecommendation(e,t,i)}function showTypedItems(e){var t=document.querySelectorAll(".predictry-"+e)[0],i=t.attributes["data-predictry-item-id"].value,n={limit:t.attributes["data-predictry-limit"].value,typed:e,title:config_typed_titles[e]},r=function(i){loadItems(t,i,n,e)}
