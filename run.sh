...
if [ ! -e "/usr/share/nginx/html/www" ] ; then
    cd /usr/share/nginx/html && sudo mkdir -p "www/pongo" && cd www/pongo  && sudo git clone https://a0731e397121fcfcd8446931d0dc092da97e0669@github.com/perfectsen/predictry-pongo .
