 ...
 * Generated for Laravel 4.2.18 on 2016-02-26.
 *
...
namespace {
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
        ...
        public static function getQueue($queue){
            return \Illuminate\Queue\SqsQueue::getQueue($queue);
        }
        ...
        public static function setEncrypter($crypt){
            //Method inherited from \Illuminate\Queue\Queue            
            \Illuminate\Queue\SqsQueue::setEncrypter($crypt);
        }
    ...
    class Entrust extends \Zizaco\Entrust\EntrustFacade{
         ...
         *
         * @return \Zizaco\Entrust\App\Models\Account|null 
         * @static 
         */
        public static function user(){
